...
namespace UrzisoftCarflowBackendApp.DatabaseInfrastructure.Migrations
{
    ...
    [Migration("20230516164125_Add-admin-posibility-for-dashboard")]
    partial class Addadminposibilityfordashboard
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("UrzisoftCarflowBackendApp.Entities.CarService", b =>
                {
                    ...
                    b.Property<int>("CarServiceCityId")
                        .HasColumnType("int");

                    b.Property<string>("Description")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("MainBrandId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("UrzisoftCarflowBackendApp.Entities.User", null)
                        .WithMany()
            ...
            modelBuilder.Entity("UrzisoftCarflowBackendApp.Entities.CarService", b =>
                {
                    b.HasOne("UrzisoftCarflowBackendApp.Entities.City", "CarServiceCity")
                        .WithMany()
                        .HasForeignKey("CarServiceCityId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("UrzisoftCarflowBackendApp.Entities.Brand", "MainBrand")
                        .WithMany()
                        .HasForeignKey("MainBrandId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("CarServiceCity");
